...
[SYMB] = LAYOUT_ergodox(
        ...
        // right hand
        ___,      ___,     ___,     ___,     ___,     ___,     ___,
        ___,      ___,     KC_7,    KC_8,    KC_9,    KC_ASTR, ___,
                  ___,     KC_4,    KC_5,    KC_6,    KC_PLUS, KC_MINS,
        ___,      KC_AMPR, KC_1,    KC_2,    KC_3,    KC_SLSH, ___,
...
[NUMB] = LAYOUT_ergodox(
        // left hand
        ___,          ___,        ___,        ___,         ___,         ___,         ___,
        KC_KP_PLUS,   LSFT(KC_1), LSFT(KC_2), LSFT(KC_3),  LSFT(KC_4),  LSFT(KC_5),  ___,
        KC_EQL,       KC_1,       KC_2,       KC_3,        KC_4,        KC_5,
        ___,          KC_HOME,    KC_PGDN,    KC_PGUP,     KC_END,      ___,         ___,
        ___,          ___,        ___,        ___,         ___,
                                                                        ___,         ___,
                                                                                     ___,
                                                           ___,         ___,         ___,
